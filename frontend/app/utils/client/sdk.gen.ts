...
export const postApiSanaGuestsIdSync = <ThrowOnError extends boolean = false>(options: Options<PostApiSanaGuestsIdSyncData, ThrowOnError>) => (options.client ?? client).post<PostApiSanaGuestsIdSyncResponses, PostApiSanaGuestsIdSyncErrors, ThrowOnError>({
    requestValidator: async (data) => await z.object({
        ...
        path: zPostApiSanaGuestsIdSyncPath,
        query: z.never().optional()
    }).parseAsync(data),
 ...
 * #### Controller:
 *
 * `hotel/internal/httpapi/sana.SanaModule.syncRooms`
 *
 * #### Middlewares:
 *
 * - `github.com/go-fuego/fuego.defaultLogger.middleware`
 ...
 *
 */
export const postApiSanaSyncRooms = <ThrowOnError extends boolean = false>(options?: Options<PostApiSanaSyncRoomsData, ThrowOnError>) => (options?.client ?? client).post<PostApiSanaSyncRoomsResponses, PostApiSanaSyncRoomsErrors, ThrowOnError>({
    requestValidator: async (data) => await z.object({
        body: z.never().optional(),
        headers: zPostApiSanaSyncRoomsHeaders.optional(),
        path: z.never().optional(),
        query: z.never().optional()
    }).parseAsync(data),
